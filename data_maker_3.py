...
class DataSelector():
    def __init__(self,image_list_path,output_name):#,pose_file_path,output_name):
    ...
    def select_process(self):
        ...
        count_for_name = 0
        result_pose_data = []
        for i_im in range(0,len(image_paths)-2):
            print(i_im)
            ...
            save_image_name = self.output_name+'ntsd_group_'+str(count_for_name).zfill(6)+'.png'
        ...
        np.savetxt('motion_'+self.output_name+'.txt',result_pose_data)
        '''
...
if __name__ == '__main__':
    ...
    data_selector = DataSelector(image_list_path,output_name)#,pose_file_path,motion_output_name)
