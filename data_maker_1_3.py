...
class DataSelector():
    def __init__(self,image_list_path,output_name):#,pose_file_path,motion_output_name):
    ...
    def select_process(self):
        ...
        for i_im in range(0,len(image_paths)-2):
            ...
            image_name_next = image_paths.ix[i_im+2,0]
            ...
            save_image_name = self.output_name+'cmu_bright'+'_'+str(count_for_name).zfill(6)+'.png'
...
if __name__ == '__main__':
    ...
    data_selector = DataSelector(image_list_path,output_name)
